...
crc32 = ngx.crc32_short
hash_fn = function(key)
...
function _M.new(self, consistent_buckets)
...
function _M.add(self, item, weight)
    self.initialized = false
    weight = weight or 1
    table.insert(self.HASH_PEERS, {weight, item})
end

function _M.delete(self, item)
    self.initialized = false
    local dels = {}
